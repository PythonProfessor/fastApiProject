...
entity_table = sqlalchemy.Table(
    ...
    # sqlalchemy.Column('boost', sqlalchemy.ForeignKey('boost.id'))
)
...
pairing_table = sqlalchemy.Table(
    ...
    sqlalchemy.Column('pet_id_1', sqlalchemy.ForeignKey('entity.id')),
    sqlalchemy.Column('pet_id_2', sqlalchemy.ForeignKey('entity.id')),
...
pairing_bid_table = sqlalchemy.Table(
    ...
    sqlalchemy.Column('owner_id', sqlalchemy.ForeignKey('entity.id', ondelete='NO ACTION')),
    sqlalchemy.Column('pairing', sqlalchemy.ForeignKey('pairing.id', ondelete='NO ACTION')),
)
